<template>
  <div 
  :class="{ 'sticky top-0 z-10 drop-shadow-lg transition ease-in-out duration-700': !view.atTopOfPage }" 
  class="bg-gray-900 h-20 flex items-center"
  >
    <div class="px-4 w-full max-w-full lg:px-8 xl:px-28">
      <div class="relative flex items-center justify-between">
        ...
        <ul class="items-center hidden space-x-8 lg:flex">
          ...
          <li>
            <a href="/" aria-label="Our product" title="Our product"
              class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Skils</a>
          </li>
          <li>
            ...
            <div class="p-5 bg-white border rounded shadow-sm">
              ...
              <nav>
                <ul class="space-y-4">
                  ...
                  <li>
                    <a href="/"
                      class="inline-flex items-center justify-center w-full h-10 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                      aria-label="Sign up" title="Sign up">
                      Sign up
                    </a>
                  </li>
